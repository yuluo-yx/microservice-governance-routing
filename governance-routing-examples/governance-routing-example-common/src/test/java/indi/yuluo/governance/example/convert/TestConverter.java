...
package indi.yuluo.governance.example.convert;
...
import indi.yuluo.governance.routing.config.GovernanceRoutingCommonConfig;
import indi.yuluo.governance.routing.converter.Converter;
import indi.yuluo.governance.routing.converter.JsonConverter;
...
public class TestConverter {
	...
	@ImportAutoConfiguration({ GovernanceRoutingCommonConfig.class })
