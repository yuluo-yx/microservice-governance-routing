...
gateway_example_docker_path="apps/gateway-consumer-example/gateway-consumer-example"
zuul_example_project_path=${example_path}"zuul-consumer-example/target"
zuul_example_docker_path="apps/gateway-consumer-example/zuul-consumer-example"
feign_example_project_path=${example_path}"web-client-consumer-example/openfeign-consumer-example/target"
feign_example_docker_path="apps/web-client-consumer-example/feign-consumer-example"
rest_example_project_path=${example_path}"web-client-consumer-example/restTemplate-consumer-example/target"
rest_example_docker_path="apps/web-client-consumer-example/rest-consumer-example"
reactive_example_project_path=${example_path}"web-client-consumer-example/reactive-consumer-example/target"
reactive_example_docker_path="apps/web-client-consumer-example/reactive-consumer-example"
provider_example_project_path=${example_path}"routing-service-provider-example/target"
provider_example_docker_path="apps/service-provider-example"
...
cp ../../../${reactive_example_project_path}/reactive-consumer-example-*.jar ./${reactive_example_docker_path}/app.jar
