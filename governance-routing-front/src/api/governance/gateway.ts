...
// gateway v2 版本测试
export const gatewayV2Request = (params: any) => get('http://localhost:19098/routing-service-provider/test-a1?id=' + `${params.id}`, null)
...
// zuul v2 版本测试
export const zuulV2Request = (params: any) => get('http://localhost:19099/routing-service-provider/test-a1?id=' + `${params.id}`, null)
